...
HallGameConfig.game.IconConfig = {
    ...
    [HallGameConfig.game.ID_FISHGAME] = "hall_res/hall/bb_dating_youxitubiao_5_1.png",
    ...
    [HallGameConfig.game.ID_LHJGame] = "hall_res/hall/bb_dating_youxitubiao_13_1.png",
...
HallGameConfig.allGames = {
	[HallGameConfig.game.ID_DDZGame] = {
		...
		[HallGameConfig.GameSecondTitleResKey]	      =	"hall_res/game_select/np_zh_ddz_chart/bb_fc_ddz_biaotizi.png",
		[HallGameConfig.SecondRoomKey]		          = {
			{
				[HallGameConfig.SecondRoomNameKey]			  = "新手场",
				[HallGameConfig.SecondRoomIDKey] 			  = 1,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_ddz_chart/BB_icon_ddz_xsc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_ddz_chart/BB_icon_ddz_cjc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_ddz_chart/BB_icon_ddz_gjc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_ddz_chart/BB_icon_ddz_fhc.png",
	...
	[HallGameConfig.game.ID_GFLOWER] = {
		...
		[HallGameConfig.SecondRoomKey]		          = {
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 2,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_zhajinhua_chart/BB_icon_zjh_cjc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 3,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_zhajinhua_chart/BB_icon_zjh_gjc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 4,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_zhajinhua_chart/BB_icon_zjh_fhc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_zhajinhua_chart/BB_icon_zjh_gbc.png",
				-- [HallGameConfig.SecondRoomIconEffectKey]	  = "baobo_zjh_choice_02#ani_04",
				-- [HallGameConfig.SecondRoomMinMoneyLimitKey]	  = 2000,
				-- [HallGameConfig.SecondRoomMinJettonLimitKey]  =	500
			}
	...
	[HallGameConfig.game.ID_BRNNGame] = {
		...
		-- [HallGameConfig.GameSecondEffectResKey]	      = "anim/game_select/baobo_zjh_choice_02/baobo_zjh_choice_02.ExportJson",--前面为资源名，后面为动画名
		[HallGameConfig.GameSecondTitleResKey]	      =	"hall_res/game_select/np_zh_bairenniuniu_chart/brnn_biaotizi.png",
		[HallGameConfig.SecondRoomKey]		          = {
			{
				[HallGameConfig.SecondRoomNameKey]			  = "小牛场",
				[HallGameConfig.SecondRoomIDKey] 			  = 2,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_bairenniuniu_chart/brnn_xnc.png",
			...
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 1,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_bairenniuniu_chart/brnn_gbc.png",
	...
	[HallGameConfig.game.ID_LHJGame] = {
		...
		-- [HallGameConfig.GameSecondEffectResKey]	      = "anim/game_select/baobo_zjh_choice_02/baobo_zjh_choice_02.ExportJson",--前面为资源名，后面为动画名
		[HallGameConfig.GameSecondTitleResKey]	      =	"hall_res/game_select/np_zh_laohuji_chart/bb_fc_lhj_biaotizi.png",
		[HallGameConfig.SecondRoomKey]		          = {
			{
				[HallGameConfig.SecondRoomNameKey]			  = "练习",
				[HallGameConfig.SecondRoomIDKey] 			  = 1,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_laohuji_chart/bb_fc_lhj_tb1.png",
				-- [HallGameConfig.SecondRoomIconEffectKey]	  = "baobo_zjh_choice_02#ani_01",
				-- [HallGameConfig.SecondRoomMinMoneyLimitKey]	  = 200,
				-- [HallGameConfig.SecondRoomMinJettonLimitKey]  =	10
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 2,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_laohuji_chart/bb_fc_lhj_tb2.png",
				-- [HallGameConfig.SecondRoomIconEffectKey]	  = "baobo_zjh_choice_02#ani_02",
				-- [HallGameConfig.SecondRoomMinMoneyLimitKey]	  = 600,
				-- [HallGameConfig.SecondRoomMinJettonLimitKey]  =	100
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 3,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_laohuji_chart/bb_fc_lhj_tb3.png",
				-- [HallGameConfig.SecondRoomIconEffectKey]	  = "baobo_zjh_choice_02#ani_03",
				-- [HallGameConfig.SecondRoomMinMoneyLimitKey]	  = 1000,
				-- [HallGameConfig.SecondRoomMinJettonLimitKey]  =	300
			},
			{
				...
				[HallGameConfig.SecondRoomIDKey] 			  = 4,
				[HallGameConfig.SecondRoomIconKey]			  = "hall_res/game_select/np_zh_laohuji_chart/bb_fc_lhj_tb4.png",
				-- [HallGameConfig.SecondRoomIconEffectKey]	  = "baobo_zjh_choice_02#ani_04",
				-- [HallGameConfig.SecondRoomMinMoneyLimitKey]	  = 2000,
				-- [HallGameConfig.SecondRoomMinJettonLimitKey]  =	500
			},
