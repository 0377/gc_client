...
local SceondaryZJHNode = class("SceondaryZJHNode",requireForGameLuaFile("secondary_game_node.SecondaryBaseNode"))
function SceondaryZJHNode:ctor()
	
	local nodeFullPath = CustomHelper.getFullPath("SecondaryZJHNodeCCS.csb")
	...
	SceondaryZJHNode.super.ctor()

end
function SceondaryZJHNode:initViewData(secondRoomInfoTab,clickCallback,canSelected)	
	if not SceondaryZJHNode.super.initViewData(self,secondRoomInfoTab,clickCallback,canSelected) then
		return false
	end
