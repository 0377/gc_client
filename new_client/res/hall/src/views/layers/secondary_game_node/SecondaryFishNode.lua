...
local SecondaryFishNode = class("SecondaryFishNode",requireForGameLuaFile("secondary_game_node.SecondaryBaseNode"))
function SecondaryFishNode:ctor()
	local nodeFullPath = CustomHelper.getFullPath("SecondaryFishNodeCCS.csb")
	...
	SecondaryFishNode.super.ctor()
end

function SecondaryFishNode:initViewData(secondRoomInfoTab,clickCallback,canSelected)
	if not SecondaryFishNode.super.initViewData(self,secondRoomInfoTab,clickCallback,canSelected) then
		return false
	end
