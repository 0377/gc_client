...
function SecondaryDZPKNode:ctor(secondRoomInfoTab,clickCallback)
	local nodeFullPath = CustomHelper.getFullPath("SecondaryDZPKNodeCCS.csb")
	...
	SecondaryDZPKNode.super.ctor(self,secondRoomInfoTab,clickCallback)
end

function SecondaryDZPKNode:initViewData(secondRoomInfoTab,clickCallback,canSelected)
	if not SecondaryDZPKNode.super.initViewData(self,secondRoomInfoTab,clickCallback,canSelected) then
		return false
	end
