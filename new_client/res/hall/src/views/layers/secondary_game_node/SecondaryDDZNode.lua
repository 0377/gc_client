...
local SecondaryDDZNode = class("SecondaryDDZNode",requireForGameLuaFile("secondary_game_node.SecondaryBaseNode"))
function SecondaryDDZNode:ctor()
	local nodeFullPath = CustomHelper.getFullPath("SecondaryDDZNodeCCS.csb")
	...
	SecondaryDDZNode.super.ctor()
end

function SecondaryDDZNode:initViewData(secondRoomInfoTab,clickCallback,canSelected)
	if not SecondaryDDZNode.super.initViewData(self,secondRoomInfoTab,clickCallback,canSelected) then
		return false
	end
