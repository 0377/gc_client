...
Image_4:loadTexture("hall_res/game_select/dmz.png",0)
...
Image_4:setPosition(131.0638, 74.2030)
layout = ccui.LayoutComponent:bindLayoutComponent(Image_4)
layout:setPositionPercentYEnabled(true)
layout:setPositionPercentX(0.2881)
layout:setPositionPercentY(0.3805)
layout:setPercentWidth(0.2286)
layout:setPercentHeight(0.1538)
layout:setSize({width = 104.0000, height = 30.0000})
layout:setLeftMargin(131.0638)
layout:setRightMargin(219.9362)
layout:setTopMargin(105.7970)
layout:setBottomMargin(59.2030)
game_panel:addChild(Image_4)

--Create min_jetton_limit
local min_jetton_limit = ccui.TextAtlas:create([[0.01]],
...
min_jetton_limit:setPosition(247.7239, 74.2030)
...
layout:setSize({width = 64.0000, height = 24.0000})
layout:setLeftMargin(247.7239)
layout:setRightMargin(143.2761)
layout:setTopMargin(108.7970)
layout:setBottomMargin(62.2030)
