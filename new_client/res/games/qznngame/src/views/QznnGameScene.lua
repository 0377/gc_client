requireForGameLuaFile("QznnConfig")
requireForGameLuaFile("QznnDefine")
requireForGameLuaFile("QZNNPoker")
requireForGameLuaFile("QznnGameManager")
local DeviceUtils = requireForGameLuaFile("DeviceUtils")
--local QznnGameEnd = requireForGameLuaFile("QznnGameEnd");
local SubGameBaseScene = requireForGameLuaFile("SubGameBaseScene")
local QznnGameScene = class("QznnGameScene",SubGameBaseScene);
...
local cardTypeImagePath = {
	[QznnGameManager.CardType.BANKER_CARD_TYPE_NONE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_mn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_ONE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n1.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_TWO] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n2.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_THREE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n3.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n4.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n5.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_SIX] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n6.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_SEVEN] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n7.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_EIGHT] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n8.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_NINE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_n9.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_TEN] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_nn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_yn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_KING] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_jn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_SAMES] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_zdn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_SAMLL] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_wxn.png"),
	[QznnGameManager.CardType.BANKER_CARD_TYPE_ERROR] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_mn.png"),
	
}

local cardTypeSoundPath = {
	[QznnGameManager.CardType.BANKER_CARD_TYPE_NONE] = "qznnsound/paixing/no.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_ONE] = "qznnsound/paixing/niu_1.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_TWO] = "qznnsound/paixing/niu_2.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_THREE] = "qznnsound/paixing/niu_3.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR] = "qznnsound/paixing/niu_4.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE] = "qznnsound/paixing/niu_5.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_SIX] = "qznnsound/paixing/niu_6.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_SEVEN] = "qznnsound/paixing/niu_7.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_EIGHT] = "qznnsound/paixing/niu_8.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_NINE] = "qznnsound/paixing/niu_9.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_TEN] = "qznnsound/paixing/niu_10.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING] = "qznnsound/paixing/yinniu.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_KING] = "qznnsound/paixing/jinniu.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_SAMES] = "qznnsound/paixing/sizha.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_SAMLL] = "qznnsound/paixing/fiveniu.mp3",
	[QznnGameManager.CardType.BANKER_CARD_TYPE_ERROR] = "qznnsound/paixing/no.mp3",
...
----注册消息
function QznnGameScene:registerNotification()
    ...
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerTableMatching);
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerSendCards);
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerBeginToContend);
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerPlayerContend)
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerChoosingBanker)

    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerPlayerBeginToBet)
    self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerPlayerBet)
	self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerShowOwnCards)
	self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerShowCards)
	self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerGameEnd)

	self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerForceToLeave)
	self:addOneTCPMsgListener(QznnGameManager.MsgName.SC_BankerReconnectInfo)

	--self:addOneTCPMsgListener(HallMsgManager.MsgName.SC_StandUpAndExitRoom)
	
    QznnGameScene.super.registerNotification(self);
...
----接收消息
function QznnGameScene:receiveServerResponseSuccessEvent(event)
    ...
    if msgName == QznnGameManager.MsgName.SC_BankerTableMatching then --匹配
			--
		--清空筹码
		self:clearChouMa()

    elseif msgName == QznnGameManager.MsgName.SC_BankerSendCards then ---发牌
		--清空筹码
		self:clearChouMa()
	
		self:faPai()

    elseif msgName == QznnGameManager.MsgName.SC_BankerBeginToContend then ---开始抢庄
		
    elseif msgName == QznnGameManager.MsgName.SC_BankerPlayerContend then ---其它玩家的抢庄倍数
		
		

    elseif msgName == QznnGameManager.MsgName.SC_BankerChoosingBanker then ---定庄
		--self:dingZhuang(userInfo)
		self:dingZhuangStart(userInfo)
    elseif msgName == QznnGameManager.MsgName.SC_BankerPlayerBeginToBet then ---闲家开始下注
       
		
    elseif msgName == QznnGameManager.MsgName.SC_BankerPlayerBet then ---闲家下注
        --
		self:xiaZhu(userInfo)
   
	elseif msgName == QznnGameManager.MsgName.SC_BankerShowOwnCards then ---玩家看到自己的牌
		self:tanPai(userInfo)
	--
	elseif msgName == QznnGameManager.MsgName.SC_BankerShowCards then--展示牌桌各玩家牌	消息个数=玩家人数
		self:showCard(userInfo)
		
	elseif msgName == QznnGameManager.MsgName.SC_BankerGameEnd then--结算
		self:doEnd(userInfo)
	...
	elseif msgName == QznnGameManager.MsgName.SC_BankerReconnectInfo then--断线重入 房间汇总信息/等待信息
		self:reConnectFaPai()
    ...
    QznnGameScene.super.receiveServerResponseSuccessEvent(self,event)
end
...
---重新连接成功
function QznnGameScene:callbackWhenReloginAndGetPlayerInfoFinished(event)
    -- body
    print("重新连接成功")
...
--请求失败通知，网络连接状态变化
function QznnGameScene:callbackWhenConnectionStatusChange(event)
    QznnGameScene.super.callbackWhenConnectionStatusChange(self,event);
    print("网络断开连接")
end

----收到服务器返回的失败的通知，如果登录失败，密码错误
function QznnGameScene:receiveServerResponseErrorEvent(event)
    
    local userInfo = event.userInfo;
    local msgName = userInfo["msgName"]

    ---申请上庄失败 允许上庄按钮点击，并且显示界面
    -- if msgName == QznnGameManager.MsgName.SC_OxForBankerFlag then
...
----初始化要加载的资源
function QznnGameScene.getNeedPreloadResArray()
    -- body
    local  res = {
		--CustomHelper.getFullPath("anim/qznn_px_eff/qznn_px_eff.ExportJson"),
...
function QznnGameScene:onEnterTransitionFinish()
    ---发送开始消息
	self.qznnGameManager:sendPlayerReconnection()
end
...
function QznnGameScene:ctor()
    ...
    ---初始化数据对象
    self.qznnGameManager = QznnGameManager:getInstance();

    QznnGameScene.super.ctor(self);

    ---初始化界面
    local csNodePath = CustomHelper.getFullPath("qznnGameLayerCCS.csb")
    ...
    ---背景音乐
    --MusicAndSoundManager:getInstance():playMusicWithFile("brnnSound/"..gameQznn.Sound.brnnBg, true)
	...
	---背景音乐
    MusicAndSoundManager:getInstance():playMusicWithFile("qznnsound/background.mp3", true)
	
end

--初始化跑马灯
function QznnGameScene:initMarquee()
...
--
function QznnGameScene:showMarqueeTip()
...
myPlayTime = {}
function QznnGameScene:playsound(sound,deltime)
	if deltime == nil then
		deltime = 0.2
	end
...
--展开按钮 动画
function QznnGameScene:zhankaiMenuAnim(speed)
...
--折叠按钮 动画
function QznnGameScene:zhedieMenuAnim(speed)
...
--初始menu
function QznnGameScene:initMenu()
	local menunode = self.csNode:getChildByName("Panel_menu")
			...
			if self.qznnGameManager:getDataManager().isMatch == true then
				...
				CustomHelper.showAlertView(
				   ...
				   function(tipLayer)
					...
					--MusicAndSoundManager:getInstance():playerSoundWithFile("qznnsound/tuichu.mp3")
					self:exitGame()
					tipLayer:removeFromParent()
			   end)
	...
	menunode:getChildByName("Button_help"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			--MusicAndSoundManager:getInstance():playerSoundWithFile("qznnsound/popup.mp3")
			
			local _gameTipsLayer = requireForGameLuaFile("QznnGameTips");
	...
	menunode:getChildByName("Button_talk"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			--
			--[[
			local _gameTalk = requireForGameLuaFile("QznnGameTalk");
...
function QznnGameScene:playAnim(animName,position)
...
function QznnGameScene:createChouMaSprite(num)
	...
	for k,v in ipairs(userlist) do
		...
		if v.cards ~= nil then
			for k1,v1 in ipairs(v.cards) do
				...
				local pokercard = QZNNPoker.new(false, v1)
...
----发牌
function QznnGameScene:faPai()
	
	self:playsound("qznnsound/kaiju.mp3")
		...
		if v.cards ~= nil then
			for k1,v1 in ipairs(v.cards) do
				...
				pokercard:runAction(cc.Sequence:create(
								...
								cc.CallFunc:create(function()
									MusicAndSoundManager:getInstance():playerSoundWithFile("qznnsound/fapai.mp3")
								end),
								actionmove,
								cc.CallFunc:create(function()
...
----摊牌
function QznnGameScene:tanPai(msg)
	
	self:playsound("qznnsound/tanpai.mp3")
...
----展示牌型(亮牌)
function QznnGameScene:showCard(msg)
	...
	if msg.cards_type == QznnGameManager.CardType.BANKER_CARD_TYPE_NONE then
		
	elseif 	msg.cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_ONE and
			msg.cards_type <= QznnGameManager.CardType.BANKER_CARD_TYPE_NINE then
		self:playAnim("ani_07",pos1)
	elseif msg.cards_type == QznnGameManager.CardType.BANKER_CARD_TYPE_TEN then
...
function QznnGameScene:reConnectDingZhuang()
	local users = self.qznnGameManager:getDataManager():getUserInfoList()
	local tableinfo = self.qznnGameManager:getDataManager():getTableInfo()
	local myinfo = self.qznnGameManager:getDataManager():getMyInfo()
	if tableinfo == nil or users == nil or myinfo == nil then
	...
	if tableinfo.state == QznnGameManager.TexasStatus.STATUS_DICISION_BANKER then
		local userlistCCS = self.csNode:getChildByName("Panel_middle")
...
function QznnGameScene:playEndDingZhuang(msg)
	...
	local zhuangjia = self.qznnGameManager:getDataManager():getUserInfoByChair(msg.banker_chair)
	...
	--local dingzhuangsprite  = cc.Sprite:create(CustomHelper.getFullPath("game_res/zhujiemian/qznn_icon_zhuang_1.png"))
...
--
function QznnGameScene:dingZhuangStart(msg)
...
----定庄
function QznnGameScene:dingZhuang(msg)
	...
	self.dingzhuang_scheduler = scheduler:scheduleScriptFunc(
			function(dt)
				...
				if lastposnum ~= posnum then
					MusicAndSoundManager:getInstance():playerSoundWithFile("qznnsound/jiantou.mp3")
				end
...
--清空桌面上的筹码
function QznnGameScene:clearChouMa()
...
function QznnGameScene:createChouMa(num)
...
----重连下注
function QznnGameScene:reConnectXiaZhu()
	--飞筹码到桌子上
	
	local users = self.qznnGameManager:getDataManager():getUserInfoList()
	local tableinfo = self.qznnGameManager:getDataManager():getTableInfo()
	local myinfo = self.qznnGameManager:getDataManager():getMyInfo()
	local zhuangjia = self.qznnGameManager:getDataManager():getZhuangJiaInfo()
	if tableinfo == nil or users == nil or myinfo == nil then
		return
	end
...
----下注
function QznnGameScene:xiaZhu(msg)
	--飞筹码到桌子上
	...
	chouma:runAction(
				...
				cc.CallFunc:create(function(sender)
					...
					MusicAndSoundManager:getInstance():playerSoundWithFile("qznnsound/xiazhu.mp3")
				end)))
...
----桌面筹码飞向赢家并显示加钱
function QznnGameScene:choumaFlyToWinneer(winner)
	if winner == nil then
		return
	end
...
--显示结算界面
function QznnGameScene:showEnd(msg)
	...
	self.csNodeOver:getChildByName("Panel_bg"):getChildByName("Button_next"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendPlayerOperate()
...
----重连结算
function QznnGameScene:reConnectDoEnd()
	...
	if tableinfo.state == QznnGameManager.TexasStatus.STATUS_SHOW_DOWN then
		self:doEnd()
	end
...
----结算
function QznnGameScene:doEnd(msg)
...
--更新桌面信息
function QznnGameScene:updateTable(dt )
	...
	local datamanager = self.qznnGameManager:getDataManager()
	...
	--dump(self.qznnGameManager.gameDetailInfoTab)
	--self.brnnGameManager.gameDetailInfoTab["second_game_type"]gameDetailInfoTab
	Panel_dizhu:getChildByName("Text_1"):setString( self.qznnGameManager.gameDetailInfoTab["room_name"])
	
	--倒计时
	local Panel_timer = middlenode:getChildByName("Panel_timer")
	
	if 	tableinfo.state == QznnGameManager.TexasStatus.STATUS_CONTEND_BANKER or
		tableinfo.state == QznnGameManager.TexasStatus.STATUS_BET or
...
--初始化自己按钮
function QznnGameScene:initMyBtn( )
	...
	Panel_qiangzhuang:getChildByName("Button_1"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerContend(-1)
	...
	Panel_qiangzhuang:getChildByName("Button_3"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerContend(2)
	...
	Panel_qiangzhuang:getChildByName("Button_4"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerContend(3)
	...
	Panel_qiangzhuang:getChildByName("Button_5"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerContend(4)
	...
	Panel_xiazhu:getChildByName("Button_1"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerPlayerBet(tableinfo.bottom_bet*zhuangjia.ratio*1)
	...
	Panel_xiazhu:getChildByName("Button_2"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerPlayerBet(tableinfo.bottom_bet*zhuangjia.ratio*2)
	...
	Panel_xiazhu:getChildByName("Button_3"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerPlayerBet(tableinfo.bottom_bet*zhuangjia.ratio*3)
	...
	Panel_xiazhu:getChildByName("Button_4"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerPlayerBet(tableinfo.bottom_bet*zhuangjia.ratio*4)
	...
	Panel_xiazhu:getChildByName("Button_5"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			self.qznnGameManager:sendBankerPlayerBet(tableinfo.bottom_bet*zhuangjia.ratio*5)
	...
	Panel_caipai:getChildByName("Button_1"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			if myinfo.pre_cards_type == QznnGameManager.CardType.BANKER_CARD_TYPE_NONE then
				MyToastLayer.new(cc.Director:getInstance():getRunningScene(), "没牛")
			elseif 	myinfo.pre_cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_ONE and
					myinfo.pre_cards_type <= QznnGameManager.CardType.BANKER_CARD_TYPE_TEN then
				self:upMy3Card10()
			elseif myinfo.pre_cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING and
					myinfo.pre_cards_type <= QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_KING then
				self:upPre3Card()
			elseif myinfo.pre_cards_type == QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_SAMES then
				self:upMy4CardSame()
			elseif myinfo.pre_cards_type == QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_SAMLL then			
				self:upPre5Card()
			end
	...
	Panel_caipai:getChildByName("Button_2"):addTouchEventListener(function (sender, eventType)
		if eventType == ccui.TouchEventType.ended then
			...
			if myinfo.pre_cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING  then
				self.qznnGameManager:sendBankerPlayerGuessCards()
			else
				--有牛
				if 	myinfo.pre_cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_ONE and 
					myinfo.pre_cards_type <= QznnGameManager.CardType.BANKER_CARD_TYPE_TEN then
...
function QznnGameScene:getShowPos(chair)
	local tableinfo = self.qznnGameManager:getDataManager():getTableInfo()
	if tableinfo == nil then
		return nil
	end
...
function QznnGameScene:getUserInfoNodeFromChairid(chair)
...
function QznnGameScene:updateUserInfo(dt )
	...
	for k, v in pairs(users) do
		...
		if uNode ~= nil then
			...
			--if tableinfo.state == QznnGameManager.TexasStatus.STATUS_SHOW_DOWN and v.cards_type ~= nil then
...
--找出3张牌点之和为整10的数
function QznnGameScene:get3CardTen(cards)
...
--找出4张相同的牌
function QznnGameScene:get4CardSame(cards)
...
--选择出前3张牌
function QznnGameScene:upPre3Card()
...
--选择出前5张牌
function QznnGameScene:upPre5Card()
...
--选择出4张相同的牌
function QznnGameScene:upMy4CardSame()
...
--选择出3张整10的牌
function QznnGameScene:upMy3Card10()
...
function QznnGameScene:isMy3UpCard10()
...
function QznnGameScene:getMyUpCard()
	local tableinfo = self.qznnGameManager:getDataManager():getTableInfo()
	local myinfo = self.qznnGameManager:getDataManager():getMyInfo()
	local zhuangjia = self.qznnGameManager:getDataManager():getZhuangJiaInfo()
	if tableinfo == nil or myinfo == nil or zhuangjia == nil then
...
function QznnGameScene:updatePlayerBtn(dt )
	...
	if tableinfo.state == QznnGameManager.TexasStatus.STATUS_SEND_CARDS then
		Panel_dingzhuang:setVisible(false)
		Panel_qiangzhuang:setVisible(false)
		Panel_xiazhu:setVisible(false)
		Panel_caipai:setVisible(false)
		
	elseif tableinfo.state == QznnGameManager.TexasStatus.STATUS_CONTEND_BANKER then
		Panel_dingzhuang:setVisible(false)
	...
	elseif tableinfo.state == QznnGameManager.TexasStatus.STATUS_DICISION_BANKER then
		--Panel_dingzhuang:setVisible(true)
		Panel_qiangzhuang:setVisible(false)
		Panel_xiazhu:setVisible(false)
		Panel_caipai:setVisible(false)
	elseif tableinfo.state == QznnGameManager.TexasStatus.STATUS_BET then
		Panel_dingzhuang:setVisible(false)
		Panel_qiangzhuang:setVisible(false)
	...
	elseif tableinfo.state == QznnGameManager.TexasStatus.STATUS_SHOW_CARD then
		Panel_dingzhuang:setVisible(false)
		Panel_qiangzhuang:setVisible(false)
		Panel_xiazhu:setVisible(false)
		...
		if myinfo.cards_type ~= nil then
			...
			local preCardTypeImagePathPressed = {
				[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_button_yn_pressed.png"),
				[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_KING] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_button_jn_pressed.png"),
				[QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_SAMES] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_button_zdn_pressed.png"),
				[QznnGameManager.CardType.BANKER_CARD_TYPE_FIVE_SAMLL] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_button_wxn_pressed.png"),
				
			}
			
			local prebtn = Panel_caipai:getChildByName("Button_2")
			--[QznnGameManager.CardType.BANKER_CARD_TYPE_NONE] = CustomHelper.getFullPath("game_res/zhujiemian/qznn_button_meiniu.png")
			if myinfo.pre_cards_type >= QznnGameManager.CardType.BANKER_CARD_TYPE_FOUR_KING  then
	...
	elseif tableinfo.state == QznnGameManager.TexasStatus.STATUS_SHOW_DOWN then
		Panel_dingzhuang:setVisible(false)
		Panel_qiangzhuang:setVisible(false)
		Panel_xiazhu:setVisible(false)
		Panel_caipai:setVisible(false)
...
--更新设备信息
function QznnGameScene:updateDeviceInfo(dt)
...
--更新信息
function QznnGameScene:update(dt )
...
----退出房间
function QznnGameScene:exitGame(issend ,openSecondLayer)
    ...
    ---释放资源
    local needLoadResArray = QznnGameScene.getNeedPreloadResArray();
	...
	if issend == true then
		self.qznnGameManager:sendPlayerLeave()
	end
