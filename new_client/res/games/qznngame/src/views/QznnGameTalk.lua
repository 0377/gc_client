...
-- QznnGameTalk = class("QznnGameTalk", function()
...
-- function QznnGameTalk:ctor(talkSendFunc)

--     local csNodePath = CustomHelper.getFullPath("qznn_quicktalk.csb")
...
-- function QznnGameTalk:dismiss(data)
...
-- function QznnGameTalk:show(playerLabel,bankerLabel,shuishouLabel,numZ,numD,numN,numX,numB)
