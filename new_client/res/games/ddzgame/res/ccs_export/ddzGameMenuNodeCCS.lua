...
btn_info:setPosition(34.6800, 21.1159)
...
layout:setPercentHeight(0.2466)
layout:setSize({width = 88.0000, height = 91.0000})
layout:setLeftMargin(-9.3200)
layout:setRightMargin(1.3200)
layout:setTopMargin(302.3841)
layout:setBottomMargin(-24.3841)
bg_menu:addChild(btn_info)

--Create btn_property
local btn_property = ccui.Button:create()
btn_property:ignoreContentAdaptWithSize(false)
btn_property:loadTextureNormal("game_res/ddz_fangjianshuxinganniu.png",0)
btn_property:loadTexturePressed("game_res/ddz_fangjianshuxinganniu_1.png",0)
btn_property:loadTextureDisabled("game_res/ddz_fangjianshuxinganniu_1.png",0)
btn_property:setTitleFontSize(14)
btn_property:setTitleColor({r = 65, g = 65, b = 70})
btn_property:setScale9Enabled(true)
btn_property:setCapInsets({x = 15, y = 11, width = 58, height = 69})
btn_property:setLayoutComponentEnabled(true)
btn_property:setName("btn_property")
btn_property:setTag(263)
btn_property:setCascadeColorEnabled(true)
btn_property:setCascadeOpacityEnabled(true)
btn_property:setVisible(false)
btn_property:setPosition(34.6800, -77.9258)
layout = ccui.LayoutComponent:bindLayoutComponent(btn_property)
layout:setPositionPercentX(0.4335)
...
layout:setLeftMargin(-9.3200)
layout:setRightMargin(1.3200)
layout:setTopMargin(401.4258)
layout:setBottomMargin(-123.4258)
bg_menu:addChild(btn_property)
